...
def main():
    ...
    if page_selection == "Recommender System":
        ...
        movie_1 = st.selectbox('First Option',title_list[14930])
        movie_2 = st.selectbox('Second Option',title_list[25055])
        movie_3 = st.selectbox('Third Option',title_list[21100])
